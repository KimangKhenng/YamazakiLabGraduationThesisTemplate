...
\subsection{Beta Policy}\label{subsec:beta-policy}
...
\end{equation}
where $R_{G}$ is the global reward defined as $R_{G} = \frac{1}{k} \sum_{k}^{i=0}R_{k} $
...
\subsection{Centralized Training and Decentralized Execution}\label{subsec:centralized-training-and-decentralized-execution}
