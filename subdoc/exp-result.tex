...
\begin{figure}[H]
    ...
    PPO Beta (proposed method) and standard PPO Gaussian.}\label{fig:single_agent_success_rate}
\end{figure}
...
\begin{figure}[H]
    ...
    PPO Beta (proposed method) and standard PPO Gaussian.}\label{fig:figure6}
\end{figure}
